...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class LoginTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                JSONObject jsonObject = restAPI.Mlogin(strings[0], strings[1]);
            ...
            if (s.contains("Unable to resolve host")) {
                ...
                try {
                    ...
                    if (ans.compareTo("false") == 0) {
                        ...
                        UserPref.setValue(LoginActivity.this, "rid", array.getJSONObject(0).getString("data2"));
                        Intent intentLogin = new Intent(LoginActivity.this, OrderActivity.class);
