...
public class BookingPojo implements Serializable {
    ...
    odate, otime, dDate, status, payment, did, uname;
    ...
    public BookingPojo(String oid, String tprice, String rid, String uid, String add, String city, String pincode, String latlng, String phone, String odate, String otime, String dDate, String status, String payment, String did, String uname) {
        this.oid = oid;
        this.tprice = tprice;
        this.rid = rid;
        this.uid = uid;
