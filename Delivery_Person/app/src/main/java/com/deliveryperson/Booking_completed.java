...
public class Booking_completed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.i(TAG, "onCreateView: completed " + UserPref.getId(getActivity()) + src + date);
        return v;
    }
                        ...
                        for (int j = 0; j < jarry.length(); j++) {
                            ...
                            pojo = new BookingPojo
                                    (object.getString("Oid"),
                                            ...
                                            object.getString("Uname"), object.getString("Rname"), object.getString("Rcont"));
