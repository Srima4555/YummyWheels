...
public class OrderAdap extends BaseAdapter {
    ...
    private Booking_pending bookingCurrent;
    private Booking_completed bookingPrev;
    private Fragment fragment;

    public OrderAdap(Context context, ArrayList<BookingPojo> issuedBookPojos, Booking_completed bookingPrev) {
        this.context = context;
        this.bookingPojos = issuedBookPojos;
        fragment = this.bookingPrev = bookingPrev;
    }

    public OrderAdap(Context context, ArrayList<BookingPojo> issuedBookPojos, Booking_pending bookingCurrent) {
        this.context = context;
        this.bookingPojos = issuedBookPojos;
