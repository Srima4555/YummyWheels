...
import com.website.yummywheels.webservices.JSONParser;
import com.website.yummywheels.webservices.RestAPI;
...
public class AddOrDetailRestauActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
    ...
    Calendar fCal, tCal;
    private SimpleDateFormat sdFormat, simpleDateFormat;
    ...
    private void initUI() {
        ...
        //title aacordingly
        if ((restaurantPojo = (RestaurantPojo) getIntent().getSerializableExtra(com.website.yummywheels.utils.UtilConstants.RESTAU_ID)) != null) {
            isUpdate = true;
            edit = true;
        }
        ...
        managerTV = findViewById(R.id.tv_manger);
        ...
        llManagerDetail = findViewById(R.id.ll_manager);
        ...
        if (isUpdate) {
            ...
            llManagerDetail.setVisibility(View.GONE);
            mNameET.setVisibility(View.GONE);
            mEmailET.setVisibility(View.GONE);
            mContET.setVisibility(View.GONE);
            ...
            iViewUploaded.setImageBitmap(com.website.yummywheels.utils.UtilConstants.decodeBitmap(encode));
        } else {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_mgr:
                    Intent intentMgr = new Intent(AddOrDetailRestauActivity.this, ManagerActivity.class);
                    intentMgr.putExtra(UtilConstants.RESTAU_ID, restaurantPojo.getRid());
                    startActivity(intentMgr);
                    return true;
                case R.id.navigation_menu:
                    Intent intentMenu = new Intent(AddOrDetailRestauActivity.this, MenuActivity.class);
                    intentMenu.putExtra(UtilConstants.RESTAU_ID, restaurantPojo.getRid());
                    startActivity(intentMenu);
                    return true;
                case R.id.navigation_review:
                    Intent intentReview = new Intent(AddOrDetailRestauActivity.this, ReviewActivity.class);
                    intentReview.putExtra(UtilConstants.RESTAU_ID, restaurantPojo.getRid());
    ...
    public void startCamera() {
        if (com.website.yummywheels.utils.PermissionUtils.requestPermission(
                this,
    ...
    public void onImageUploadClick(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddOrDetailRestauActivity.this);
        builder
                .setMessage(R.string.dialog_select_prompt)
                .setPositiveButton(R.string.dialog_select_gallery, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        AddOrDetailRestauActivity.this.startGalleryChooser();
                    }
                })
                .setNegativeButton(R.string.dialog_select_camera, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        AddOrDetailRestauActivity.this.startCamera();
                    }
                });
        builder.create().show();
    }
    ...
    public void startGalleryChooser() {
        if (com.website.yummywheels.utils.PermissionUtils.requestPermission(this, GALLERY_PERMISSIONS_REQUEST, Manifest.permission.READ_EXTERNAL_STORAGE)) {
    ...
    private void requestPerm() {
        ActivityCompat.requestPermissions(AddOrDetailRestauActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION
    ...
    private void permissionInit() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(AddOrDetailRestauActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED ||
                    ContextCompat.checkSelfPermission(AddOrDetailRestauActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(AddOrDetailRestauActivity.this, RCODE_RES_CURRENTLOC);
                            Log.i(TAG, "onResult: LocationSettingsStatusCodes.RR");
                        } catch (IntentSender.SendIntentException e) {
                            e.printStackTrace();
                            Toast.makeText(AddOrDetailRestauActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
            }
    ...
    void makeLatLongDialog() {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                Geocoder geocoder = new Geocoder(AddOrDetailRestauActivity.this, Locale.ENGLISH);
    ...
    public void onRequestPermissionsResult(
        ...
        switch (requestCode) {
            case CAMERA_PERMISSIONS_REQUEST:
                if (com.website.yummywheels.utils.PermissionUtils.permissionGranted(requestCode, CAMERA_PERMISSIONS_REQUEST, grantResults)) {
                    startCamera();
                }
                break;
            case GALLERY_PERMISSIONS_REQUEST:
                if (com.website.yummywheels.utils.PermissionUtils.permissionGranted(requestCode, GALLERY_PERMISSIONS_REQUEST, grantResults)) {
                    startGalleryChooser();
                }
                break;
        }
    ...
    public void setImg(Uri uri) {
        if (uri != null) {
            try {
                ...
                encode = com.website.yummywheels.utils.UtilConstants.encodeBitmap(bitmap);
            } catch (IOException e) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_switch_restau, menu);
        ...
        if (isUpdate) {
            if (restaurantPojo.getStatus() != null)
                if (restaurantPojo.getStatus().equalsIgnoreCase("open")
                        || restaurantPojo.getStatus().equalsIgnoreCase(YES)) {
        ...
        if (getIntent().getSerializableExtra(com.website.yummywheels.utils.UtilConstants.RESTAU_ID) != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.mi_del_food) {
            del();
        }
    ...
    private void del() {
        AlertDialog.Builder ad = new AlertDialog.Builder(AddOrDetailRestauActivity.this);
        ad.setMessage("Want to remove this food item from Menu?");
        ...
        ad.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                task.execute(restaurantPojo.getRid());
                Log.i("tag", "onClick: " + restaurantPojo.getRid());
            }
        });
        ad.show();
    }
    ...
    private void update() {
        ...
        if (rNameET.getText().toString().isEmpty()) {
            ...
            task.execute(restaurantPojo.getRid(),
                    rNameET.getText().toString(), contactET.getText().toString(), addET.getText().toString(), cityET.getText().toString(), pincodeET.getText().toString(),
    ...
    private void submit() {
        ...
        if (rNameET.getText().toString().isEmpty()) {
            ...
            Snackbar.make(sView, "Please select image for this restaurant", Snackbar.LENGTH_SHORT).show();
        } else if (mNameET.getText().length() == 0) {
            Snackbar.make(sView, "Please enter manager's name", Snackbar.LENGTH_SHORT).show();
        } else if (mEmailET.getText().length() == 0) {
            Snackbar.make(sView, "Please enter manager's email", Snackbar.LENGTH_SHORT).show();
            ...
            Snackbar.make(sView, "Enter valid Email id", Snackbar.LENGTH_LONG).show();
        } else if (mContET.getText().length() == 0) {
            Snackbar.make(sView, "Please enter manager's contact", Snackbar.LENGTH_SHORT).show();
        } else if (!MobileNumberValidation.isValid(contactET.getText().toString())) {
            Snackbar.make(sView, "Enter valid restaurant's contact number", Snackbar.LENGTH_LONG).show();
        } else if (!MobileNumberValidation.isValid(mContET.getText().toString())) {
            Snackbar.make(sView, "Enter valid manager's contact number", Snackbar.LENGTH_LONG).show();
        } else {
            SubmitRestauTask task = new SubmitRestauTask();
            ...
            task.execute(
                    ...
                    cuisineString,
                    latlong,
                    timeForDelivET.getText().toString(),
                    costET.getText().toString(),
                    encode,
                    minOrderET.getText().toString(),
                    typeET.getText().toString(),
                    statusET.getText().toString(),
                    mNameET.getText().toString(),
                    mEmailET.getText().toString(),
                    mContET.getText().toString());
            Log.i(TAG, "submit: " + rNameET.getText().toString() + contactET.getText().toString() + addET.getText().toString() + pincodeET.getText().toString() +
                    cuisineString + latlong + timeForDelivET.getText().toString() + costET.getText().toString() + encode +
                    minOrderET.getText().toString() + typeET.getText().toString() + statusET.getText().toString() +
                    mNameET.getText().toString() + mEmailET.getText().toString() + mContET.getText().toString());
        }
    }
    ...
    public void onClick(View v) {
        ...
        } else  if (R.id.btn_update_orsubmit == id) {
            if (btnSubmitOrUpdate.getText().toString().equalsIgnoreCase("update")) {
                update();
            } else if (btnSubmitOrUpdate.getText().toString().equalsIgnoreCase("submit")) {
                if(latlong == null){
                    Snackbar.make(sView, "Please click on Location Icon", Snackbar.LENGTH_LONG).show();
                } else {
                    submit();
                }
            }
    ...
    private void startAnimation() {
        dialogLoader = new Dialog(AddOrDetailRestauActivity.this, R.style.AppTheme_NoActionBar);
    ...
    private void changeStatus() {
        if (isUpdate) {
            ...
            task.execute(restaurantPojo.getRid(), checked);
            Log.i(TAG, "changeStatus: " + restaurantPojo.getRid() + checked);
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Unable to resolve host")) {
                ...
                try {
                    ...
                    Toast.makeText(AddOrDetailRestauActivity.this, "Error:" + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private class SubmitRestauTask extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... strings) {
            String result;
            com.website.yummywheels.webservices.RestAPI restAPI = new com.website.yummywheels.webservices.RestAPI();
            try {
                JSONObject jsonObject = restAPI.AddRest(strings[0], strings[1], strings[2], strings[3], strings[4], strings[5], strings[6], strings[7], strings[8], strings[9]
            ...
            if (s.contains("Unable to resolve host")) {
                ...
                try {
                    ...
                    if (ans.compareTo("already") == 0) {
                        ...
                        Toast.makeText(AddOrDetailRestauActivity.this, "Manager's Email already exists", Toast.LENGTH_SHORT).show();
                    } else if (ans.compareTo("true") == 0) {
                        Toast.makeText(AddOrDetailRestauActivity.this, "Restaurant added successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (ans.compareTo("error") == 0) {
                        String error = json.getString("Data");
                        Snackbar.make(sView, error, Snackbar.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddOrDetailRestauActivity.this, "Error:" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    Log.d(com.website.yummywheels.utils.UtilConstants.TAG, e.getMessage());
                }
            }
        }
    }
    ...
    private class DelTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            com.website.yummywheels.webservices.RestAPI restAPI = new com.website.yummywheels.webservices.RestAPI();
            try {
                JSONObject jsonObject = restAPI.DeleteRestaurant(strings[0]);
                com.website.yummywheels.webservices.JSONParser jsonParser = new com.website.yummywheels.webservices.JSONParser();
                result = jsonParser.parseJSON(jsonObject);
            } catch (Exception e) {
                result = e.getMessage();
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Unable to resolve host")) {
                ...
                try {
                    ...
                    Log.d("reply", ans);
                    if (ans.compareTo("true") == 0) {
                        Toast.makeText(AddOrDetailRestauActivity.this, "Restaurant deleted", Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (ans.compareTo("error") == 0) {
                        String error = json.getString("Data");
                        Snackbar.make(sView, error, Snackbar.LENGTH_SHORT).show();
            ...
            if (s.contains("Unable to resolve host")) {
                ...
                try {
                    ...
                    if (ans.compareTo("already") == 0) {
                        ...
                        Toast.makeText(AddOrDetailRestauActivity.this, "Restaurant updated successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (ans.compareTo("error") == 0) {
                        String error = json.getString("Data");
                        Snackbar.make(sView, error, Snackbar.LENGTH_SHORT).show();
